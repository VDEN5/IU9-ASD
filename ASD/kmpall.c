...
/* P.S.:алгоритм примечателен тем, что старый алгоритм особо не изменен,
я использовал обычную рекурсию, алгоритм легко понять, разобравшись в переменной костыль)))*/
